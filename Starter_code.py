...
class SimpleCNN(nn.Module):
    def __init__(self):
        ...
        # Two convolutional layers followed by pooling, and two fully-connected layers.
        ...
        # CIFAR-100 images are 32x32; after two poolings: 32/2/2 = 8
        self.fc1 = nn.Linear(64 * 8 * 8, 256)
        self.fc2 = nn.Linear(256, 100)  # 100 classes for CIFAR-100

    def forward(self, x):
        # First conv block: conv1 -> ReLU -> pool
        x = self.pool(F.relu(self.conv1(x)))
        # Second conv block: conv2 -> ReLU -> pool
